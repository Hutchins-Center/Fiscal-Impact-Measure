...
arp_cont %>% 
  ...
  ggplot(aes(x = date, y = value, fill = name)) +
  geom_col(width = 30) +
  scale_fill_hutchins(labels = c('Aid to small businesses','Unemployment insurance',  'Medicaid expansion', 'Aid to S&L governments', 'Other direct aid', 'Aid to vulnerable households', 'Rebate Checks' )) +
  ...
  labs(title = 'Components of the contribution of the American Rescue Plan Act to real GDP growth', 
       caption = '**Source**: Hutchins Center calculations from Bureau of Economic Analysis and Congressional Budget Office data. 
       **Note:** Other aid to vulnerable households includes ') +
