...
arp_cont %>% 
  ...
  ggplot(aes(x = date, y = value, fill = name)) +
  geom_col(width = 30) +
  scale_fill_hutchins(labels = c('Aid to small businesses','Unemployment insurance',  'Medicaid expansion', 'Aid to S&L governments', 'Other direct aid', 'Other aid to vulnerable households', 'Rebate Checks' )) +
