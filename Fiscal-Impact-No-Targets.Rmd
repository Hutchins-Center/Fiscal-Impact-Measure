...
librarian::shelf("tidyverse", "magrittr", "ggthemes", "ggtext", "tinytex", "ggthemes", "gridExtra", "fim", "glue", "lubridate",
"conflicted")

#theme_set(theme_hutchins())
source('R/functions.R')
source('targets_code_no_tarmake.R')
...
last_hist_date = as_date("2021-03-31")
