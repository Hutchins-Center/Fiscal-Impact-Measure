...
previous %>%
  ...
  theme_hc() + geom_vline(xintercept  = last_hist_date, linetype =  'dotted')  + geom_vline(xintercept  = last_hist_date, linetype =  'dotted')  +
...
previous %>%
  ...
  labs(x = '',
    ...
    scale_fill_brewer(name = "", labels = c('Previous', 'Updated'), type = 'qual', palette = 'Paired',                      direction = 1) + 
  theme_hc() + geom_vline(xintercept  = last_hist_date, linetype =  'dotted')  +
  theme(plot.title.position = 'plot')
```
