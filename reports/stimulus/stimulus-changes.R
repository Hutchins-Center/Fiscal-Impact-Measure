...
stimulus <-
  ...
  select(date, ends_with('net_taxes'), ends_with('xmpc')) %>%
...
write_xlsx(stimulus, glue('{update_path}/fim_stimulus_net_xmpc.xlsx'))
write_xlsx(no_stimulus, glue('{update_path}/fim_nostimulus_net_xmpc.xlsx'))
