...
comp = c("gdph", "gdppothq", "gdp","c", "yptmr","yptmd","g","gf","gfb", "gfeg", "gs", "gfrpt","gfrpri","gfrcp","gfrs","gsrpt","gsrpri","gsrcp","gsrs","gftfp","gstfp","gdppotq","jgdp","jc","jgf","jgs") #  "gfegnet", "gftfpnet","gstfpnet","ysptmd","yfptmd",
