...
lp(xxx[,c("date", "gsnet_yy", "gstx_yy", "gstfpnet_yy")], labelz = c("Purchases (net federal grants)", "Tax revenues (all sources)", "Transfers (net Medicaid grants)"), t = "", end.date = Sys.Date())
...
xx[,paste0(comp, "_use")] = xx[,comp]
gdp1 <- lm(gsrpt~t+gdp_use + shift(gdp_use, 1) + shift(gdp_use, 2), xx)
gdp2 <- lm(gsrpri~t+gdp_use + shift(gdp_use, 1) + shift(gdp_use, 2), xx)
gdp3 <- lm(gsrcp~t+gdp_use + shift(gdp_use, 1) + shift(gdp_use, 2), xx)
gdp4 <- lm(gsrs~t+gdp_use + shift(gdp_use, 1) + shift(gdp_use, 2), xx)
...
xx[,paste0(comp, "_use")] = xx[,comp]
c1 <- lm(gsrpt~t+c_use + shift(c_use, 1) + shift(c_use, 2), xx)
c2 <- lm(gsrpri~t+c_use + shift(c_use, 1) + shift(c_use, 2), xx)
c3 <- lm(gsrcp~t+c_use + shift(c_use, 1) + shift(c_use, 2), xx)
c4 <- lm(gsrs~t+c_use + shift(c_use, 1) + shift(c_use, 2), xx)
...
xx[,paste0(comp, "_use")] = xx[,comp]
hpx1 <- lm(gsrpt~t+ shift(hpx_use, 1) + shift(hpx_use, 3)+ shift(hpx_use, 5), xx)
hpx2 <- lm(gsrpri~t+ shift(hpx_use, 1) + shift(hpx_use, 3)+ shift(hpx_use, 5), xx)
hpx3 <- lm(gsrcp~t+ shift(hpx_use, 1) + shift(hpx_use, 3)+ shift(hpx_use, 5), xx)
hpx4 <- lm(gsrs~t+ shift(hpx_use, 1) + shift(hpx_use, 3)+ shift(hpx_use, 5), xx)
